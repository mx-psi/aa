...
def parte2(iris):
  ...
  for cls, name in enumerate(iris.target_names):
    ...
    print(" {}: \n  # en training: {}\n  # en test: {}"
          .format(name, train_number, test_number))
  espera()
...
def parte3():
  ...
  plt.plot(x, sin_values, 'k--',  # sin
           x, cos_values, 'b--',  # cos
           x, sc_values,  'r--')  # sin + cos

  print("Muestra seno (negro), coseno (azul) y suma (rojo) (en ventana aparte)")
  plt.show()
